	...
	private static class PrimesComparator implements Comparator<String> {
		...
		public int compare(String str1, String str2) {
			...
			if (str1.length() < 9 && str2.length() < 9){
				...
				int m = new Integer(str2);

				int product1 = productOfPrimeFactorsint(n);
				int product2 = productOfPrimeFactorsint(m);
		...
		private static Integer productOfPrimeFactorsint(int n) {
			int prime1 = 1;
			int prime2 = 1;
